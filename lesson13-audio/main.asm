...
clear_stack:
  ...
  LDA #%10000000 | %00000001
  STA APU_TRI_CTRL

  ;; Lets play some music!
  ;; LDA #%00000100 | %00000010 | %00000001 ;; Enable triangle, square2 and square1 channel
  ;; STA APUFLAGS

  ;; Duty 00 = 12.5%
  ;; Manual volume control via bits
  ;; Medium volume (8)
  ;; LDA #%00000000 | %00110000 | %00001000
  ;; STA APU_SQ1_ENV

  ;; Duty 01 = negated 25%
  ;; Manual volume control via bits
  ;; Lower volume (6)
  ;; LDA #%01000000 | %00110000 | %00000110
  ;; STA APU_SQ2_ENV
...
run:
    ...
    ;; Update game state
    ;; Configure apu based on current flags, volume, and note index
