...
;_add_dec_to_dec:
;  DEY
;  PHA ;; Load next n's digit
;  ADC [ptr], Y
;  CMP #$09
;  BSC add_overflow ; if the addition exceeds 9, set the carry bit for next add
;  ;; Condition: SUM does not exceed 9; clear carry bit
;  CLC
;  JMP _add_dec_to_dec_overflow_done
;_add_oveflow: ;
; ;; Condition: SUM does exceed 9; set carry bit
;  SEC
;_add_dec_to_dec_overflow_done:
;  STA [ptr], Y
;  CMY #$00
;  BNE _add_dec_to_dec
;  RTS
