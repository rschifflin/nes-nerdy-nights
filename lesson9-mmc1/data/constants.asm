...
MM1_RESET_BIT            = %10000000
MM1_CONFIG_SHIFT_REGISTER = $8000
MM1_CHR_BANK0_SHIFT_REGISTER = $A000
MM1_CHR_BANK1_SHIFT_REGISTER = $C000
MM1_PRG_BANK_SHIFT_REGISTER  = $E000
